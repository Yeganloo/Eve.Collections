...
namespace Eve.CollectionsTest
{
    ...
    {
        private const int Round = 900;

        [Fact]
        public void _ReversSequence_ReadWrite()
        {

            var array = new CopyOnWriteArray<object>();
        ...
        public void _CopyConstructor()
        {
            ...
            var array2 = new CopyOnWriteArray<object>(array);
            for (int i = 0; i < Round; i++)
            {
        ...
        public void CopyTo()
        {
            ...
            IDynamicArray<int> array = new CopyOnWriteArray<int>();
            for (int i = 0; i < Round; i++)
            {
                array.Add(i);
            }
        ...
        {
            int rem = 73;
            IDynamicArray<int> array = new CopyOnWriteArray<int>(10);
            for (int i = 0; i < 90; i++)
            {
                array.Add(i);
            }
